module SearchAlphabet
  ...
  # or '0' based on the fact whether the Nth letter of the alphabet is present in the input
  ...
  # alphabet.
  # For instance:
  # Givin string "a   **&  cZ" and returns "10100000000000000000000001"
  def self.call str
    # code here
  end
end
